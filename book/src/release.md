...
- **0.3.1 (2025-12-13)**: Introduced `skrills-validate` (Claude Code permissive and Codex strict frontmatter) and `skrills-analyze` (token counting and dependency analysis) crates.
